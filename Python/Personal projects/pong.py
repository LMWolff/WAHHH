...
class Pong(Frame):
    ...
    def initUI(self):
        ...
        self.ball = self.canvas.create_oval(0+self.ballX, 0+self.ballY, 15+self.ballX, 15+self.ballY, outline="black", 
            fill="red", width=1)
        self.paddle1 = self.canvas.create_rectangle(0+self.paddle1X, 0+self.paddle1Y, 10+self.paddle1X, 150+self.paddle1Y, outline="#fb0", fill="#fb0")
        self.paddle2 = self.canvas.create_rectangle(0+self.paddle2X, 0+self.paddle2Y, 10+self.paddle2X, 150+self.paddle2Y, outline="#fb0", fill="#fb0")
